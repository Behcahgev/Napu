"""
Django settings for napu project.
...
SECRET_KEY = '$j86s@)b##d$6^lzn4tu@zq(vscwu0a$__u-duh-=$n@54v5c5'
...
WSGI_APPLICATION = 'napu.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'dbNapu',             # Nom de la base de données
        'USER': 'vincent',
        'PASSWORD': 'pass',
